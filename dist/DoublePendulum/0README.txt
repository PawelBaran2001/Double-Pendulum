W tym folderze znajduje się plik DoublePendulum.exe.
Po jego uruchomieniu można wybrac wszystkie interesujące parametry symulacji jak masy, długości ramion i inne parametry rysowania.
Po kliknięciu przycisku symulacja należy obserwować komunikaty w panelu na dole okna.
Po zakończeniu symulacji, zostanie utworzony folder "frames" w któym znajdą się wszystkie klatki symulacji.
Można je wykorzystać w dowolny sposób. W tym samym folderze znajdzie się także plik Animacja.gif z gotową animacją.
