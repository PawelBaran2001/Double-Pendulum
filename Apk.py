...
def make_plot(i, x1, x2, y1, y2, r, kolor1, kolor2, ax, s1, s2, L1, L2, di, max_trail):
...
def wykonanie():
    while True:
        ...
        E = calc_E(m1, m2, L1, L2, g, y)
        if np.max(np.sum(np.abs(calc_E(m1, m2, L1, L2, g, y) - E))) > EDRIFT:
        ...
        for i in range(0, t.size, di):
            ...
            make_plot(i, x1, x2, y1, y2, r, kolor1, kolor2, ax, s1, s2, L1, L2, di, max_trail)
