...
[sg.Text("Kąt początkowy pierwszej masy (w stponiach)"), sg.Input(justification=)],  # value 0
[sg.Text("Kąt początkowy drugiej masy (w stopniach):"), sg.Input()],  # value 1
[sg.Text("Masa pierwsza (kg):"), sg.Input()],  # value2
[sg.Text("Masa druga (kg):"), sg.Input()],  # value3
[sg.Text("Ramię pierwsze (m):"), sg.Input()],  # value4
[sg.Text("Ramię drugie (m):"), sg.Input()],  # value5
[sg.Text("Przyspieszenie ziemskie"), sg.Input()],  # value6
[sg.Button('Symulacja')]]